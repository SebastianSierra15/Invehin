...
<%
    java.util.List<Permiso> permisos = new java.util.ArrayList<>();

    if (session.getAttribute("sesion") != null)
    {
        permisos = ((Usuario) session.getAttribute("sesion")).rolUsuario.permisosRol;
    }
%>
<%
...
<aside id="sidebar" class="fixed z-40 top-0 left-0 bg-invehin-accent h-screen w-64 flex flex-col justify-between border-r-2 border-black transition-all duration-300 p-4">
    ...
    <div class="overflow-y-auto flex-1">
        <nav class="flex flex-col gap-2">
            ...
            <% if (tienePermiso(idsPermisos, 4))
                { %>
            <a href="${pageContext.request.contextPath}/Views/clientes/clientes.jsp" name="nav-item" class="flex items-center gap-2 text-black font-semibold px-4 py-2 rounded border-2 border-black bg-invehin-backgroundAlt hover:bg-invehin-primaryLighter">
            ...
            <% if (tienePermiso(idsPermisos, 9))
                { %>
            <a href="${pageContext.request.contextPath}/Views/pedidos/pedidos.jsp" name="nav-item" class="flex items-center gap-2 text-black font-semibold px-4 py-2 rounded border-2 border-black bg-invehin-backgroundAlt hover:bg-invehin-primaryLighter">
            ...
            <% if (tienePermiso(idsPermisos, 11))
                { %>
            <a href="${pageContext.request.contextPath}/Views/inventario/inventario.jsp" name="nav-item" class="flex items-center gap-2 text-black font-semibold px-4 py-2 rounded border-2 border-black bg-invehin-backgroundAlt hover:bg-invehin-primaryLighter">
            ...
            <% if (tienePermiso(idsPermisos, 14))
                { %>
            <a href="${pageContext.request.contextPath}/Views/promociones/promociones.jsp" name="nav-item" class="flex items-center gap-2 text-black font-semibold px-4 py-2 rounded border-2 border-black bg-invehin-backgroundAlt hover:bg-invehin-primaryLighter">
            ...
            <% if (tienePermiso(idsPermisos, 1))
                { %>
            <a href="${pageContext.request.contextPath}/Views/categorias/categorias.jsp" name="nav-item" class="flex items-center gap-2 text-black font-semibold px-4 py-2 rounded border-2 border-black bg-invehin-backgroundAlt hover:bg-invehin-primaryLighter">
            ...
            <% if (tienePermiso(idsPermisos, 3))
                { %>
            <a href="${pageContext.request.contextPath}/Views/categorias/categorias.jsp" name="nav-item" class="flex items-center gap-2 text-black font-semibold px-4 py-2 rounded border-2 border-black bg-invehin-backgroundAlt hover:bg-invehin-primaryLighter">
                <i class="fas fa-users-line text-xl" title="Categorias"></i>
                <span class="sidebar-text">Usuarios</span>
            </a>
            <% }%>

            <% if (tienePermiso(idsPermisos, 12))
                { %>
            <a href="${pageContext.request.contextPath}/Views/configuracion/configuracion.jsp" name="nav-item" class="flex items-center gap-2 text-black font-semibold px-4 py-2 rounded border-2 border-black bg-invehin-backgroundAlt hover:bg-invehin-primaryLighter">
    ...
    <div class="sticky bottom-0 w-full border-t-2 border-black mt-2 pt-4">
        <div class="flex flex-col gap-2">
            <a href="${pageContext.request.contextPath}/Views/perfil/perfil.jsp" name="nav-item" class="flex items-center gap-4 text-black font-semibold px-4 py-2 rounded hover:bg-invehin-backgroundAlt">
                <i class="fas fa-user" title="Perfil"></i>
                <span class="sidebar-text">Sebastián Sierra</span>
            </a>

            <a href="${pageContext.request.contextPath}/Views/login/login.jsp" name="nav-item" class="flex items-center gap-4 text-black font-semibold px-4 py-2 rounded bg-invehin-primary text-white hover:bg-invehin-primaryLight transition-colors">
